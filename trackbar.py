...
while True:
    ...
    # ดึงค่าจาก Trackbar
    blue = cv2.getTrackbarPos("B","Color Trackbar") #ชื่อ Trackbar, ชื่อหน้าต่าง
    green = cv2.getTrackbarPos("G","Color Trackbar") #ชื่อ Trackbar, ชื่อหน้าต่าง
    red = cv2.getTrackbarPos("R","Color Trackbar") #ชื่อ Trackbar, ชื่อหน้าต่าง
